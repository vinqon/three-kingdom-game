...
const SCENARIOS = {
    ...
    18: {
        cityDefinitions: CITY_DEFINITIONS_18,
        routes: ROUTES_18
    },
    24: {
        cityDefinitions: CITY_DEFINITIONS_24,
        routes: ROUTES_24
    }
};
...
export function createLiteScenario(playerFaction, cityCount = 12, difficulty = 'easy') {
