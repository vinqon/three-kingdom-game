import { attack, endFactionTurn, legalTargets, transfer } from './actions.ts';
import { FACTION_ORDER } from './scenario.ts';
import type { CityState, FactionId, GameState } from './types.ts';
import { enumerateLegalActions, type AiDecision, type Policy } from './policies.ts';
...
export function createHeuristicPolicy(weights: HeuristicWeights, opponentPolicy: Policy): Policy {
